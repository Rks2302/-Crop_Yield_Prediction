...
plt.rc("font", size=14)
sns.set(style="white")
# sns.set(style="white grid", color_codes=True)
...
data1 = data_cu.drop(["State_Name", "Year", "AvgTemp"], axis=1)
...
print(ch)
# ch["Area"] = area_in
# ch["Rainfall"] = list(rain[rain["District_Name"] == dis.upper()]["Rainfall"])[0]
print(ch.shape)
